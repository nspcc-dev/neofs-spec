...
\newglossaryentry{NeoVM}{
  ...
  description={
    ...
    See \href{https://docs.neo.org/docs/en-us/basic/neovm.html}{Neo Documentation}
  }
}
...
\newglossaryentry{AlphabetNodes}{
  name=Alphabet nodes,
  description={
    Inner Ring nodes that share key with FS chain consensus nodes and send all NeoFS related multisigned transactions
  }
}
