...
Container contract has API (see \nameref{sec:Contracts}) for fetching actual values e.g. `GetNodeReportSummary`, `GetReportByNode`, `GetBillingStatByNode`, etc. These values can be treated as a general NeoFS state metrics. 
