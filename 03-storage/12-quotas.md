...
Quotas are stored and maintained inside Container contract. The contract provides API for fetching and setting values (see Container's methods in \nameref{sec:Contracts} for more details):
