...
| 6 | OBJECT_RANGE | Refers to object.GetRange RPC call. DEPRECATED: use parameterized Get instead. |
| 7 | OBJECT_RANGEHASH | Refers to object.GetRangeHash RPC call. DEPRECATED: should not be used. |
